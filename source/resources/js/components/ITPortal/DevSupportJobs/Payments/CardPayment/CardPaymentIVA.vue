        ...
        <div class="mt-3">
            <form class="form-flex" @submit.prevent>
                ...
                <div v-if="payments !== null && !payments.length" class="main card shadow">
                    <h2 class="pt-3 pb-2 main-header">There are no card payment errors to fix for IVA Debtsolv!</h2>
                </div>
            </form>
        </div>
    </fieldset>
...
export default {
    ...
    methods: {
        getPayments() {
            ...
            axios
                .get(vm.$baseUrl + vm.$devSupportJobsUrl + vm.$cardPayment + vm.$debtsolvIvaView, {
        ...
        processPayment() {
            ...
            axios
                .put(vm.$baseUrl + vm.$devSupportJobsUrl + vm.$cardPayment + vm.$debtsolvIvaView, paymentData, {
                    headers: {"Authorization": `Bearer ${bearerToken}`}
                })
                .then(response => {
                    vm.reason = '';
