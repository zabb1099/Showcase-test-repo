        ...
        <div class="mt-3">
            <form class="form-flex" @submit.prevent>
                ...
                <div v-if="payouts !== null && !payouts.length" class="main card shadow">
                    <h2 class="pt-3 pb-2 main-header">There are no payouts to process for IVA Debtsolv!</h2>
                </div>
            </form>
        </div>
    </fieldset>
    ...
    export default {
        ...
        methods: {
            getPayouts() {
                ...
                axios
                    .get(vm.$baseUrl + vm.$devSupportJobsUrl + vm.$processPayoutView + vm.$debtsolvIvaView, {
            ...
            processPayout() {
                ...
                axios
                    .put(vm.$baseUrl + vm.$devSupportJobsUrl + vm.$processPayoutView + vm.$debtsolvIvaView, payoutData, {
                        headers: {"Authorization": `Bearer ${bearerToken}`}
                    })
                    .then(response => {
                        vm.reason = '';
