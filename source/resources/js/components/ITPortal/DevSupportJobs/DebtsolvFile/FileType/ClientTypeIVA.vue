        ...
        <div class="mt-3">
            <div class="card shadow py-3 mb-3">
                <div class="form-flex-item-job no-border-bottom">
                    ...
                    <button @click="getClientType()" class="search-btn blue-btn" :class="{disabled: $v.$invalid}" :disabled="$v.$invalid">
            ...
            <form class="form-flex" @submit.prevent>
                ...
                <div v-if="client.length" class="pb-3">
                    <div class="table-flex-header main-table mb-3 shadow header-font">
                        ...
                        <div class="items-header flex2">Client Type</div>
                    ...
                    <div class="shadow main-table" v-for="data in client" :key="data.id">
                        <div class="table-flex-opened font-change">
                            ...
                            <div class="items-opened flex2">
                                <select class="form-field" v-model="data.client_type.ID">
                                    <option v-for="type in clientType" :value="type.id">
                                        {{ type.description }}
                                    </option>
                                </select>
                            </div>
    ...
    export default {
        ...
        methods: {
            getClientType() {
                ...
                axios
                    .get(vm.$baseUrl + vm.$devSupportJobsUrl + vm.$clientType + vm.$debtsolvIvaView, {
                        params: {
                    ...
                    .then(response => {
                        ...
                        vm.client = vm.clientData.clientType;
                        vm.clientType = vm.clientData.clientTypeDescription;
            ...
            updateClientType() {
                ...
                const clientData = {
                    client_id: vm.clientId,
                    client_type: vm.selectedClientType.client_type.ID,
                    reason: vm.reason
                }

                axios
                    .put(vm.$baseUrl + vm.$devSupportJobsUrl + vm.$clientType + vm.$debtsolvIvaView, clientData, {
            ...
            toggleShowAuditModal(clientType) {
                this.doShowAuditModal = !this.doShowAuditModal;
                if (this.doShowAuditModal) this.selectedClientType = clientType;
            },
