            ...
            <form class="form-flex" @submit.prevent>
                <div v-if="noData">
                    <div class="main card shadow">
                        <h2 class="pt-3 pb-2 main-header main-header">Lock not found!</h2>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        getClientFile() {
            ...
            axios
                .get(vm.$baseUrl + vm.$devSupportJobsUrl + vm.$unlockClientFileView + vm.$debtsolvDmView, {
                    params: {
        ...
        unlockClientFile() {
            ...
            axios
                .delete(vm.$baseUrl + vm.$devSupportJobsUrl + vm.$unlockClientFileView + vm.$debtsolvDmView, {
                    data: {
                        client_id: vm.clientId,
                        reason: vm.reason
                    },
