    ...
    export default {
        ...
        data() {
            return {
                ...
                isLoading: false,
                counts: {
                    letters: { title: 'DM Letter Count', latestCount: 0, previousCount: 0, countArray: [], status: '' },
                    emails: { title: 'DM Email Count', latestCount: 0, previousCount: 0, countArray: [], status: '' },
                    sms: { title: 'DM SMS Count', latestCount: 0, previousCount: 0, countArray: [], status: '' },
                    actionGroups: { title: 'DM Action Group Count', latestCount: 0, previousCount: 0, countArray: [] }
                }
            }
        },
        created() {
        ...
        methods: {
            getQueues() {
                ...
                axios
                    .get(vm.$baseUrl + vm.$printQueuesUrl + vm.$debtsolvDmView, {
                    ...
                    .then(response => {
                        ...
                        vm.$emit('setAllGreenDM', vm.allGreen);
                        vm.$emit('setAllAmberDM', vm.allAmber);
                        vm.$emit('setAllRedDM', vm.allRed);
