...
class IVACreateBulkCreditor implements ShouldQueue
{
    ...
    public function handle()
    {
        $newFieldValues = [
            ...
            'FromEmail' => 'fssaccounts@financialsupportsystems.co.uk',
            'ContactType' => 1,
            'FilePassword' => 'FssRemit!1',
            'EmailTemplateID' => 5,
        ...
        IVADebtsolvCreateBulkCreditorEvent::dispatch([
